 ...
 */
@Configuration
public class CapabilityRegistryServiceConsumerConfig
{
    /*
     * The logger for this class.
     */
    private static final ILogger LOGGER =
            HDCRLoggingManager.getLogger(CapabilityRegistryServiceConsumerConfig.class);
     ...
     * @since   1.0
     */
    @Bean(name="capabilityRegistryServiceListenerContainer")
    ...
    RetryOperationsInterceptor retryPolicy()
    {
        ...
        RetryPolicyExceptionUnpackerDelegate retryPolicyExceptionUnpackerDelegate =
                new RetryPolicyExceptionUnpackerDelegate(ourExceptionRetryPolicy());
