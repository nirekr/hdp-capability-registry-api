 ...
 */
@Configuration
public class CapabilityRegistryServiceRabbitConfig
{
    /*
     * The logger for this class.
     */
    private static final ILogger LOGGER = 
            HDCRLoggingManager.getLogger(CapabilityRegistryServiceRabbitConfig.class);
    ...
    ClassMapper capabilityRegistryClassMapper()
    {
        ...
        messageClasses.add(ListCapabilityProvidersMessage.class);
        messageClasses.add(CapabilityProvidersFoundMessage.class);
     ...
     */
    @Bean
    public Binding capabilityRegistryResponseQueueBinding()
    {
        final String bindingPostFix = this.getResponseQueuePostfix();
